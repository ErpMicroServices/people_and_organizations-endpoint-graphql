export default function (obj, args, context, graphql) {
  ...
  .one("insert into party (first_name, last_name, title, nickname, date_of_birth, comment, party_type_id) values(${first_name}, ${last_name}, ${title}, ${nickname}, ${date_of_birth}, ${comment}, ${party_type_id}) returning id", person)//first_name, last_name, title, nickname, date_of_birth || null, comment, person_type_id()])
  .then((party_id) => {
    if (person.email) {
      return context.database
