...
@Data
@Builder
public class PartyClassificationTypeConnection implements Connection<PartyClassificationTypeEntity> {

	private List<Edge<PartyClassificationTypeEntity>> edges;
	 ...
	 */
	@Override
	public List<Edge<PartyClassificationTypeEntity>> getEdges() {
		return edges;
	}
