...
@Data
@Builder
public class ContactMechanismConnection implements Connection<ContactMechanism> {

	private List<Edge<ContactMechanism>> edges;
	 ...
	 */
	@Override
	public List<Edge<ContactMechanism>> getEdges() {
		return edges;
	}
