package org.erpmicroservices.peopleandorganizations.endpoint.graphql.relay;
...
public class CursorBuilders {
	...
	public <T> ConnectionCursor firstCursorForm(List<Edge<T>> edges) {
		return edges.isEmpty() ? null : edges.get(0).getCursor();
	}

	public <T> ConnectionCursor lastCursorForm(List<Edge<T>> edges) {
