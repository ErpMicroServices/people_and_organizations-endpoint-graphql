...
@Data
@Builder
public class PartyRelationshipConnection implements Connection<PartyRelationship> {

	private List<Edge<PartyRelationship>> edges;
	 ...
	 */
	@Override
	public List<Edge<PartyRelationship>> getEdges() {
		return edges;
	}
